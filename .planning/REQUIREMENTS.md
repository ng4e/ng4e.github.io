...
- [x] **NAV-04**: Mobile hamburger menu as React island (client:media="(max-width: 768px)")
...
- [x] **I18N-01**: Site fully bilingual -- French and English versions of all pages
- [x] **I18N-02**: Language switcher in navbar (FR/EN toggle)
...
- [x] **I18N-05**: Blog posts have a language field -- displayed in their original language on both locale routes
- [x] **I18N-06**: SEO: hreflang tags linking FR and EN versions of each page
